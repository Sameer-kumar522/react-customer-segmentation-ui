  ...
  return (
       <div className='absolute top-0 left-0 h-full w-full  p-8 flex flex-col justify-between'>
        <h2 className='bg-white  rounded-full h-12 w-12 flex justify-center  items-center text-xl font-semibold '>{props.id+1}</h2>
         <div className=''>
          <p className=' text-shadow-2xs text-lg  leading-relaxed text-white mb-14'>{props.intro}</p>
          ...
          <button  className='bg-gray-600 text-white font-medium px-4 py-3 rounded-full text-lg'><i className="ri-arrow-right-line"></i></button>
          </div>
         </div>
      </div>
  )
